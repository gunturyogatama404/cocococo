************************************
*                                  *
*  BzMiner v17.0 Readme            *
*                                  *
************************************

ethw (EthPOW, 0.5% 开发费用)
etchash (Ethereum Classic, 0.5% 开发费用)
rvn (Ravencoin, 1.0% 开发费用)
meowcoin (Meowcoin, 1.0% 开发费用)
neoxa (Neoxa, 1.0% 开发费用)
clore (Clore, 1.0% 开发费用)
xna (Neurai, 1.0% 开发费用)
...
nexa (Nexa, 2.0% 开发费用)
ironfish (Ironfish, 1.0% 开发费用)
octa (OctaSpace, 0.5% 开发费用)
novo (Novo, 1.0% 开发费用)
kylacoin (Kylacoin, 1.0% 开发费用)
gamepass (Gamepass, 1.0% 开发费用)
canxium (Canxium, 0.5% 1.0% 开发费用)
rethereum (Rethereum, 1.0% 开发费用)
decred (Decred, 1.0% 开发费用)
